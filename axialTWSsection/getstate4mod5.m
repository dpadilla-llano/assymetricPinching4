function [state4Strain,state4Stress] = ...
    ...
    if (state4Strain(1)*state4Strain(4) <0.0)
        ...
        k34 = (state4Stress(4)-state4Stress(3))/(state4Strain(4)-state4Strain(3));
        k14 = (state4Stress(4)-state4Stress(1))/(state4Strain(4)-state4Strain(1));
        % check that reloading point is not behind point 1 
        if (state4Strain(3)<state4Strain(1))% || (k34 < k14)) % 22
    ...
    slope23 = (state4Stress(3) - state4Stress(2))/(state4Strain(3) - state4Strain(2));
    slope34 = (state4Stress(4) - state4Stress(3))/(state4Strain(4) - state4Strain(3));
    if (slope23 > slope34)
        du = state4Strain(4)-state4Strain(1);
        df = state4Stress(4)-state4Stress(1);
